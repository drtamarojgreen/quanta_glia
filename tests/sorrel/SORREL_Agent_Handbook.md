# **Sorrel Agent Handbook**

**Purpose:** To instruct AI collaborators on how to safely, incrementally, and empirically test external repositories using Sorrel.
...
All work occurs in **`tests/sorrel/`**:
...
\u2514\u2500\u2500 sdd/
    ...
    \u2514\u2500\u2500 sorrel_checkins.md   # Track unimplemented work
```

**Rules:**

1.  Never write outside `tests/sorrel/` unless explicitly authorized.
2.  Cards must follow **minimal code principle**.
3.  Runner and CLI commands (`sorrel discover`, `sorrel sip`) operate only in scoped directories.
...
3.  **Record Checkins**
    ...
    *   Track unimplemented or deferred functionality in `sorrel_checkins.md`.
...
## **6. Common Pitfalls and How Sorrel Prevents Them**
...
```text
Loading facts from tests/sorrel/sdd/facts...
...
Sorrel transforms AI from **code-generating text machines** into **empirical, responsible collaborators** capable of reliably testing external repositories.
