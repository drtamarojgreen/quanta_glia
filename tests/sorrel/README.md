...
## Checkins and Checkouts (SDD Work Ledger)

SDD uses a dual-ledger model for iterative work tracking:
- **`sdd/sorrel_checkins.md`** tracks planned, deferred, or unfinished sips.
- **`sdd/sorrel_checkouts.md`** tracks completed sips, touched artifacts, and observed outcomes.
