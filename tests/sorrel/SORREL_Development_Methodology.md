# SORREL Development Methodology

## Sorrel Driven Development (SDD)

SDD is inspired by **Behavior Driven Development (BDD)** but redesigned for **AI collaboration and evaluation**.
...
SDD replaces this with **Green Syntax**, a structured format designed **for machine reasoning first and humans second**.

---

# Design Constraints of SORREL Development
...
# SORREL Development Philosophy

The system must be built with these principles.

### Native Code

SORREL is written using **native C++** with minimal dependencies.
...
# Development Phases of SORREL

SORREL development follows a **structured expansion model**.
...
SORREL must classify AI failures.
...
The development process intentionally allows **AI agents to help build SORREL itself**.
...
# Why SDD Is Important

SDD treats AI systems as **participants in development**, not just tools.
...
SORREL becomes a **research and engineering platform** where:

* AI agents build software
* AI agents are evaluated
* AI limitations are systematically studied

SDD ensures that the **development process itself remains compatible with AI capabilities**, preventing the project from growing into something AI agents can no longer understand.

---

If you want, the next concept that would make SORREL **significantly more powerful** is designing the **Green Card Architecture**, which turns cards into something closer to **AI-operable workflow objects rather than simple test steps**.