# SORREL Checkins - Future Work for card_runner.cpp
...
- sip_create_validation_facts: Create `tests/sorrel/sdd/facts/validation.facts` with specific level-prefixed facts for testing. (Done)
