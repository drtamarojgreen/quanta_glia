...
SORREL is a **development structure** designed to make AI agents **useful collaborators for humans**.
...
SORREL accepts these limitations and **builds the workflow around them**.
...
SORREL avoids this mistake by **externalizing knowledge into artifacts** rather than relying on the agent’s internal state.

---

# SORREL Forces Agents to Learn Through Execution

Instead of relying on memory, SORREL forces agents to interact with **real outcomes**.
...
SORREL considers this workflow **harmful rather than helpful**.

---

# The SORREL Alternative

SORREL replaces speculative code generation with **verified construction**.
...
# Why SDD Emphasizes Restrictions
...
# The Role of Humans in SORREL

SORREL does not attempt to replace human engineers.
...
The key idea behind SORREL is **honesty in collaboration**.
...
SORREL acknowledges that reality.

Instead of asking AI to imagine systems correctly, SORREL forces the agent to **interact with real systems step by step**.
