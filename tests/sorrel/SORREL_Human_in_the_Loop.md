# Human-in-the-Loop (HIL) in SORREL

## Role in Sorrel Driven Development (SDD)

In SORREL, **Human-in-the-Loop (HIL)** is not a fallback mechanism but a **first-class design component**. HIL exists to guide AI reasoning at the **planning and constraint level**, rather than at the implementation level.
...
# HIL Placement in the SDD Workflow

SDD introduces HIL during the **planning phase**.
...
The SORREL engine evaluates responses against these checks.
...
The key philosophy of HIL in SORREL is:
...
# Benefits of HIL in SORREL

Introducing HIL into SDD produces several benefits.
...
# Long-Term Vision of HIL in SORREL

As SORREL grows, HIL becomes a **governance layer** for AI development.
...
If you'd like, the next concept that would strengthen SORREL significantly is designing the **SORREL Reasoning Gate System**, which acts as a checkpoint mechanism ensuring AI agents **validate their reasoning before committing to architectural decisions**.