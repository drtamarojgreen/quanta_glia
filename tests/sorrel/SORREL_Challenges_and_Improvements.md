## **Possible Challenges in Sorrel**

| Challenge                              | Description                                                        | How SDD/Sorrel Addresses It                                                   |
| -------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------------------------------- |
...
| **Placeholder / Todo Abuse**           | Agents insert `TODO`s or fake types.                               | All unfinished work goes to `sorrel_checkins.md`; code must compile/run now.  |
...
1.  **Sorrel transforms chaos into discipline** by forcing agents to work incrementally and empirically.
...
4.  Over time, **agents internalize Sorrel best practices**, reducing repeated mistakes.
