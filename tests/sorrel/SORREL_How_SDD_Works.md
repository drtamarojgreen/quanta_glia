# How Sorrel Driven Development (SDD) Works

SDD modifies the traditional development lifecycle by inserting a **Restrictions Phase** before coding begins.
...
SDD prevents them **before they exist** by defining structural guardrails.
...
# SDD Focuses on Construction Instead of Behavior
...
SDD avoids this by controlling **how code must be structured**, making many behavioral errors impossible.

---

# The Guardrail Model

SDD essentially creates **guardrails around AI code generation**.
...
SDD solves this by defining the **shape of acceptable solutions** before code generation begins.
...
SDD assumes AI agents do not fully understand intent.
...
**The SORREL Restrictions Engine**
...
This is where SORREL becomes extremely powerful because it starts functioning like a **compiler for AI-generated architecture** rather than just a testing framework.