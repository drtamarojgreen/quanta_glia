...
Green Syntax is a structured, machine-readable format used to define CDD primitives. It is designed to be easily parsed by AI while remaining strictly bounded.
...
A **Card** is a discrete unit of CDD logic (often implemented as a C++ class or Python script in this repo) that investigates a specific environmental condition.
