# Lecture Notes: Introduction to CDD (Chai Driven Development)
...
## 2. CDD: The Structural Trellis
CDD shifts the focus from **Behavior** (what happens) to **Structure** (how it is built).
-   **Trellis Metaphor:** If code is a vine, CDD is the wooden frame. The vine can grow any way it wants, as long as it stays within the frame.
...
In CDD, we don't ask "Is the code correct?" We ask "What are the facts about this environment?"
