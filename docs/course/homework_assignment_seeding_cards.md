...
## Scenario
You are designing a **"Panic Room Deceleration"** environment. The goal is to take a user from a state of high anxiety (chaotic motion, sharp edges) to a state of calm (slow rhythm, soft curves).

## Task 1: Conceptual Translation
Describe the 3D environment that represents "Calm." Mention lighting, motion, and geometry.
...
## Task 3: The Fact Probe
If you were to write a **Card** to verify this environment, what is the single most important **Fact** it should report to the registry?
*(Example: `is_motion_rhythmic = true`)*
