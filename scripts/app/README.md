...
| `negation`    | Checks for the absence of specific keywords (case-insensitive).                | `keywords`: A list of forbidden strings.                                                                      |
...
| `diff`        | Compares the answer against a golden answer using a diff ratio.                | `golden_answer`: The canonical string to compare against.<br>`threshold`: A float (0-1) for the minimum required similarity. |
